...
schema_folder_path = 'silver/table_schemas'
...
for f in files:
    ...
    # Define the table ID
    table_id = f'mstr-globalbi-sbx-c730.lh_f1_silver.{f}'

    # Define the path to your JSON schema file and CSV data file
    schema_file_path = f'silver/table_schemas/{f}.json'
    csv_file_path = f'silver/{f}.csv'
