import pandas as pd
from lib.common_functions import call_api
...
def main(latest = True):
    ...
    if latest == False:
        ...
        output_file,all_rows_df = get_json_from_api('Results','json','files/latest_data_from_api/results',limit=1000,offset=26000,counter_start=26001)
        write_api_results_to_json('json',output_file,all_rows_df)
